...
- docs/docs-index.md: doc index skeleton (DOCS-INDEX markers)
```
...
- scripts/update_docs_index.py: scan docs/ by category, parse
  ...
  between DOCS-INDEX markers in docs/docs-index.md. Title
...
- `docs/architecture/<service>.md` × N + `docs/docs-index.md`（自动区填好后会再 diff）
...
- docs/docs-index.md: categorized doc index (DOCS-INDEX, auto)
