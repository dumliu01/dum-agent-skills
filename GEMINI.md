...
| **dum-coding** | 实现或修改代码时只做验收所需的最小改动；需求不明确或需要扩大范围时先确认 | `skills/dum-coding/SKILL.md` |
| **dum-merge-code** | 安全合并 Git 代码，核对源/目标分支与提交基线，逐项处理冲突并验证；"合并代码"/"合并分支"/"处理合并冲突" | `skills/dum-merge-code/SKILL.md` |
